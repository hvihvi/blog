...
- Actually writting tests ("test last" tend to skip writting tests and move on, just like TDD skips refactoring)

## Test Pyramid

The initial idea was to have few E2E tests and many unit tests.
TDD produces many unit tests, these 2 approaches come from the same era (early 2000?).

Back then the ability to change might not have been as important as it is for most modern projects.
